...
export const ProUpgradeModal: React.FC<ProUpgradeModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black/85 backdrop-blur-md z-50 flex items-center justify-center p-4">
      <div className="bg-[#161B22] border border-[#FF6B00]/40 rounded-xl p-6 md:p-8 max-w-xl w-full space-y-6 shadow-[0_0_30px_rgba(255,107,0,0.15)] relative overflow-hidden">
        ...
        <div className="flex items-start justify-between">
          <div className="flex items-center space-x-3">
            <div className="w-10 h-10 rounded bg-[#FF6B00] flex items-center justify-center text-black font-bold shadow-[0_0_15px_rgba(255,107,0,0.3)]">
        ...
        <div className="bg-[#0D1117] border border-[#30363D] p-5 rounded-xl flex items-center justify-between">
          <div>
            <span className="text-xs font-mono text-[#FF6B00] font-bold block uppercase">
          ...
          <span className="bg-[#FF6B00]/10 text-[#FF6B00] border border-[#FF6B00]/40 text-xs px-3 py-1 rounded font-mono font-bold uppercase">
            Taahhütsüz İptal
          </span>
        </div>
        ...
        <div className="space-y-2 pt-2">
          <button
            ...
            className="w-full py-3.5 rounded bg-[#FF6B00] hover:bg-[#e66000] text-black font-extrabold text-sm shadow-[0_0_20px_rgba(255,107,0,0.25)] transition flex items-center justify-center space-x-2 uppercase"
          >
            {isProcessing ? (
