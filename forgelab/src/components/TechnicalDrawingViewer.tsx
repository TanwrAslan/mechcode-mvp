...
export const TechnicalDrawingViewer: React.FC<TechnicalDrawingViewerProps> = ({ task }) => {
  ...
  return (
    <div className="bg-[#0D131F] border border-cyan-900/50 rounded-xl overflow-hidden shadow-2xl flex flex-col">
      {/* Blueprint Header Bar */}
      <div className="bg-[#131C2E] border-b border-cyan-900/40 px-4 py-3 flex flex-wrap items-center justify-between gap-2">
        ...
        <div className="flex items-center space-x-1">
          <button
            ...
            className={`p-1.5 rounded transition ${
              showDimensions ? 'bg-cyan-600 text-white' : 'bg-slate-800 text-slate-400 hover:text-white'
            }`}
          >
          ...
          <button
            ...
            className={`p-1.5 rounded transition ${
              showGrid ? 'bg-cyan-600 text-white' : 'bg-slate-800 text-slate-400 hover:text-white'
            }`}
          >
          ...
          <button
            ...
            title="Uzaklaş"
            className="p-1.5 rounded bg-slate-800 text-slate-300 hover:bg-slate-700 transition"
          >
      ...
      {/* SVG Canvas Area */}
      <div className="relative bg-[#070B12] min-h-[380px] h-[440px] w-full overflow-hidden flex items-center justify-center p-4">
        ...
        >
          ...
          >
            ...
            <rect x="15" y="15" width="770" height="450" fill="none" stroke="#1e3a5f" strokeWidth="1.5" />
            <rect x="20" y="20" width="760" height="440" fill="none" stroke="#00f0ff" strokeWidth="1" opacity="0.4" />

            {/* Title Block (Başlık Bloğu / Antet) */}
            <g transform="translate(520, 360)">
              <rect x="0" y="0" width="255" height="95" fill="#0a1322" stroke="#00f0ff" strokeWidth="1" />
              <line x1="0" y1="24" x2="255" y2="24" stroke="#00f0ff" strokeWidth="0.8" opacity="0.6" />
              <line x1="0" y1="48" x2="255" y2="48" stroke="#00f0ff" strokeWidth="0.8" opacity="0.6" />
              <line x1="0" y1="72" x2="255" y2="72" stroke="#00f0ff" strokeWidth="0.8" opacity="0.6" />
              <line x1="130" y1="0" x2="130" y2="95" stroke="#00f0ff" strokeWidth="0.8" opacity="0.6" />

              <text x="10" y="16" fill="#00f0ff" fontSize="11" fontFamily="monospace" fontWeight="bold">
                FORGELAB ISO
              </text>
              ...
              <g transform="translate(140, 50)">
                ...
                {showDimensions && (
                  <g className="font-mono text-xs">
                    ...
                    <line x1="35" y1="60" x2="60" y2="60" stroke="#00f0ff" strokeWidth="0.8" />
                    <line x1="35" y1="240" x2="60" y2="240" stroke="#00f0ff" strokeWidth="0.8" />
                    <line x1="40" y1="60" x2="40" y2="240" stroke="#00f0ff" strokeWidth="1" markerStart="url(#arrow)" markerEnd="url(#arrow)" />
                    <rect x="15" y="140" width="48" height="18" fill="#0a1322" stroke="#00f0ff" strokeWidth="0.5" rx="3" />
                    <text x="39" y="153" fill="#00f0ff" fontSize="11" textAnchor="middle" fontWeight="bold">
                      80 mm
                    </text>

                    {/* L2: Horizontal Width (80 mm) */}
                    <line x1="60" y1="255" x2="60" y2="275" stroke="#00f0ff" strokeWidth="0.8" />
                    <line x1="300" y1="255" x2="300" y2="275" stroke="#00f0ff" strokeWidth="0.8" />
                    <line x1="60" y1="265" x2="300" y2="265" stroke="#00f0ff" strokeWidth="1" markerStart="url(#arrow)" markerEnd="url(#arrow)" />
                    <rect x="155" y="256" width="50" height="18" fill="#0a1322" stroke="#00f0ff" strokeWidth="0.5" rx="3" />
                    <text x="180" y="269" fill="#00f0ff" fontSize="11" textAnchor="middle" fontWeight="bold">
                      80 mm
                    </text>

                    {/* R8 Radius Callout */}
                    <line x1="108" y1="192" x2="150" y2="150" stroke="#f97316" strokeWidth="1.2" markerStart="url(#arrow)" />
                    <rect x="145" y="132" width="50" height="18" fill="#0a1322" stroke="#f97316" strokeWidth="0.8" rx="3" />
                    <text x="170" y="145" fill="#f97316" fontSize="11" textAnchor="middle" fontWeight="bold">
                      R8 mm
                    </text>

                    {/* Ø10 Hole Callout */}
                    <line x1="215" y1="210" x2="260" y2="130" stroke="#38bdf8" strokeWidth="1" markerStart="url(#arrow)" />
                    <rect x="250" y="112" width="75" height="18" fill="#0a1322" stroke="#38bdf8" strokeWidth="0.8" rx="3" />
                    <text x="287" y="125" fill="#38bdf8" fontSize="10" textAnchor="middle" fontWeight="bold">
                      4x Ø10 mm
                    </text>

                    {/* t = 8mm Thickness */}
                    <line x1="60" y1="45" x2="60" y2="60" stroke="#00f0ff" strokeWidth="0.8" />
                    <line x1="100" y1="45" x2="100" y2="60" stroke="#00f0ff" strokeWidth="0.8" />
                    <line x1="60" y1="50" x2="100" y2="50" stroke="#00f0ff" strokeWidth="1" markerStart="url(#arrow)" markerEnd="url(#arrow)" />
                    <rect x="62" y="32" width="36" height="16" fill="#0a1322" stroke="#00f0ff" strokeWidth="0.5" rx="2" />
                    <text x="80" y="44" fill="#00f0ff" fontSize="10" textAnchor="middle" fontWeight="bold">
                      t=8
                    </text>
                ...
                <g transform="translate(290, 10)">
                  <rect x="0" y="0" width="120" height="100" fill="#0b172a" stroke="#0284c7" strokeWidth="0.8" rx="4" />
            ...
            {drawingType !== 'bracket' && (
              <g transform="translate(100, 100)">
                ...
                {/* Radii */}
                <path d="M 140,80 Q 140,60 160,60" fill="none" stroke="#f97316" strokeWidth="2" />
                <path d="M 240,60 Q 240,40 260,40" fill="none" stroke="#f97316" strokeWidth="2" />

                {showDimensions && (
                  <g className="font-mono text-xs" fill="#00f0ff">
      ...
      <div className="bg-[#0b1322] border-t border-cyan-900/40 p-3 grid grid-cols-2 md:grid-cols-4 gap-2 text-xs">
