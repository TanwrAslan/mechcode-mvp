          ...
          >
              ...
              <g transform="translate(140, 50)">
                ...
                {showDimensions && (
                  <g className="font-mono text-xs">
                    ...
                    {/* R8 Radius Callout */}
                    <line x1="108" y1="192" x2="150" y2="150" stroke="#EF4444" strokeWidth="1.2" markerStart="url(#arrow)" />
                    <rect x="145" y="132" width="50" height="18" fill="#0a1322" stroke="#EF4444" strokeWidth="0.8" rx="3" />
                    <text x="170" y="145" fill="#EF4444" fontSize="11" textAnchor="middle" fontWeight="bold">
                      R8 mm
                    </text>
            ...
            {drawingType !== 'bracket' && (
              <g transform="translate(100, 100)">
                ...
                {/* Radii */}
                <path d="M 140,80 Q 140,60 160,60" fill="none" stroke="#EF4444" strokeWidth="2" />
                <path d="M 240,60 Q 240,40 260,40" fill="none" stroke="#EF4444" strokeWidth="2" />
