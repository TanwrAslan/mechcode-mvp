    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
      ...
      <div className="bg-[#161B22] border border-[#30363D] rounded-xl p-6 flex flex-col sm:flex-row items-center justify-between gap-6">
        <div className="flex items-center space-x-4">
          <div className="w-14 h-14 rounded bg-[#0D1117] border border-[#EF4444]/40 flex flex-col items-center justify-center font-mono shrink-0">
            <span className="text-2xl font-black text-[#EF4444]">{checkedCount}</span>
            <span className="text-[10px] text-[#8B949E] font-bold">/ {totalCount}</span>
          </div>
          <div>
            <div className="text-xs font-mono text-[#EF4444] font-bold uppercase">
              TOPLAM PUANIN
            </div>
        ...
        <div className="bg-[#0D1117] px-4 py-2.5 rounded border border-[#30363D] text-center font-mono">
          ...
          <span className="text-sm font-bold text-[#EF4444] flex items-center justify-center space-x-1 mt-0.5">
