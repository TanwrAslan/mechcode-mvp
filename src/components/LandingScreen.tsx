  ...
  return (
    <div className="space-y-16 pb-16">
      ...
      <section className="relative pt-12 pb-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto text-center overflow-hidden">
        ...
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-[#EF4444]/10 rounded-full blur-3xl pointer-events-none" />

        {/* Badge */}
        <div className="inline-flex items-center space-x-2 bg-[#161B22] border border-[#30363D] px-3.5 py-1.5 rounded-full text-xs text-[#EF4444] font-mono mb-8">
        ...
        <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
          <button
            ...
            className="w-full sm:w-auto px-8 py-4 rounded bg-[#EF4444] text-black font-extrabold text-base shadow-[0_0_20px_rgba(239,68,68,0.25)] hover:bg-[#DC2626] hover:shadow-[0_0_30px_rgba(239,68,68,0.4)] transition-all flex items-center justify-center space-x-3 group"
          >
        ...
        <div className="mt-14 pt-8 border-t border-[#30363D] max-w-3xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
          <div className="p-3 bg-[#161B22] rounded-lg border border-[#30363D]">
            <div className="text-2xl font-bold text-[#EF4444] font-mono">10+</div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {/* Pillar 1 */}
          <div className="bg-[#161B22] border border-[#30363D] rounded-xl p-6 hover:border-[#EF4444]/60 transition duration-300 flex flex-col justify-between">
            <div>
              <div className="w-10 h-10 rounded bg-[#EF4444]/10 border border-[#EF4444]/30 flex items-center justify-center text-[#EF4444] mb-4">
                <Compass className="w-5 h-5" />
              </div>
              <span className="text-[10px] font-mono text-[#EF4444] uppercase tracking-widest font-bold">1. AŞAMA</span>
            ...
            <div className="mt-4 pt-3 border-t border-[#30363D] text-[11px] text-[#EF4444] font-mono flex items-center space-x-1">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-[#161B22] border border-[#30363D] rounded-2xl p-8 md:p-12 relative overflow-hidden flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="space-y-3 text-center md:text-left">
            <span className="text-xs font-mono text-[#EF4444] bg-[#EF4444]/10 px-3 py-1 rounded border border-[#EF4444]/30 font-bold uppercase">
              HEMEN DENE
            </span>
          ...
          <button
            onClick={() => onNavigate('catalog')}
            className="px-6 py-3.5 rounded bg-[#EF4444] text-black font-extrabold text-sm shadow-[0_0_20px_rgba(239,68,68,0.2)] hover:bg-[#DC2626] transition whitespace-nowrap flex items-center space-x-2"
          >
